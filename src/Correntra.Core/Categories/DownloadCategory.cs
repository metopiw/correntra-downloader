...
public static class DefaultDownloadCategories
{
    ...
    [
        new(
            ...
            "Compressed",
            "Compressed",
            [".7z", ".br", ".bz2", ".cab", ".gz", ".iso", ".jar", ".lz4", ".rar", ".tar", ".tgz", ".xz", ".zip", ".zst"],
            ["application/gzip", "application/java-archive", "application/vnd.rar", "application/x-7z-compressed", "application/x-cab", "application/zip", "application/zstd"],
            true,
            "Category.Compressed"),
        new(
            DocumentsId,
            "Documents",
            "Documents",
            [".csv", ".djvu", ".doc", ".docm", ".docx", ".epub", ".fb2", ".md", ".odp", ".ods", ".odt", ".pdf", ".ppt", ".pptx", ".rtf", ".txt", ".xls", ".xlsb", ".xlsx", ".xps"],
            ["application/epub+zip", "application/pdf", "application/rtf", "application/vnd.ms-", "application/vnd.oasis.opendocument", "application/vnd.openxmlformats-", "text/"],
            true,
            "Category.Documents"),
        new(
            MusicId,
            "Music",
            "Music",
            [".aac", ".aiff", ".alac", ".amr", ".flac", ".m4a", ".mka", ".mp3", ".oga", ".ogg", ".opus", ".wav", ".wma"],
            ["audio/"],
            true,
            "Category.Music"),
        new(
            ...
            "Programs",
            "Programs",
            [".appinstaller", ".appx", ".appxbundle", ".bat", ".cmd", ".com", ".exe", ".msi", ".msix", ".msixbundle", ".msp", ".msu"],
        ...
        new(
            ...
            "Video",
            "Video",
            [".3gp", ".asf", ".avi", ".divx", ".f4v", ".flv", ".m2ts", ".m4v", ".mkv", ".mov", ".mp4", ".mpeg", ".mpg", ".mxf", ".ogv", ".ts", ".vob", ".webm", ".wmv"],
